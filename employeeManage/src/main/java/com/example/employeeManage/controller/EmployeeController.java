...
import com.example.employeeManage.dto.EmployeeDTO;
import com.example.employeeManage.dto.ResponseDTO;
import com.example.employeeManage.service.EmployeeService;
import com.example.employeeManage.util.VarList;
...
public class EmployeeController {
    ...
    public ResponseEntity getAllEmployyes(){
        try{
    ...
    public ResponseEntity searchEmployee(@PathVariable int empID){
        try {
            ...
            if (employeeDTO != null) {
                ...
                responseDTO.setCode(VarList.RSP_NO_DATA_FOUND);
                responseDTO.setMessage("No Empolyee Available For This empID");
                responseDTO.setContent(employeeDTO);
                return new ResponseEntity(responseDTO, HttpStatus.BAD_REQUEST);
